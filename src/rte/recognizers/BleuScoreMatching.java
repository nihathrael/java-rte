...
public class BleuScoreMatching implements EntailmentRecognizer {
	...
	public String getName() {
		if(mean) return BleuScoreMatching.class.getSimpleName() + " with arithmetic mean, depth=" + maxN;
		else return BleuScoreMatching.class.getSimpleName() + "without weighting, depth=" + maxN;
	}	
